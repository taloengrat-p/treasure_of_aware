...
import 'package:treasure_of_aware/dialogs/treasure_detect_alert/widget/treasure_detect_alert_content.dart';
...
class TreatureDetectAlertDialog {
  static show(
    ...
    required TreasureItem treasureItem,
  }) {
    showDialog(
      context: context,
      builder: (context) {
        return Dialog(
          ...
          child: TreasureDetectAlertContent(
            treasure: treasure,
